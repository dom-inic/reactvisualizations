...
const DynamicChartMarch = () => {
 ...
 const Chart = () => {
        ...
        .then(result => {
            ...
            MarchTotalllins.push(parseInt(totalllinsM));
            Marchquantity.push(parseInt(dispensedMarch[2]));
...
export default DynamicChartMarch;